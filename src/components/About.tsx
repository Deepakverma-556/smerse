...
const About = () => {
  return (
    <div className="relative max-w-[1920px] mx-auto overflow-hidden">
      <div className="max-w-[1176px] mx-auto md:px-8 px-4 flex items-center justify-between pt-[189px] max-lg:pt-24 max-sm:pt-[60px] max-lg:pb-[500px] pb-[272px] max-sm:pb-[93px] gap-10 max-lg:gap-[132px] max-sm:gap-20 max-lg:flex-wrap">
        <div>
          <Heading
            text="About Us"
      ...
      <Image
        ...
        width={954}
        height={690}
        className="pointer-events-none max-lg:mx-auto absolute top-11 right-0 max-lg:-left-40 max-xl:-right-32 max-lg:top-[412px]"
      />
    </div>
  );
};
